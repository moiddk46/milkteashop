<template>
  <div class="m-5 mt-5 border border-light rounded bg-light">
    ...
    <div class="d-flex justify-content-center">
      <form @submit.prevent="add" class="w-50" id="addkhachhang">
        <div class="mb-3">
        ...
        <span v-if="error.name == false" class="text-danger" style="font-size: 13px">
        ...
        <span v-if="error.diachi == false" class="text-danger" style="font-size: 13px">
        ...
        <span v-if="error.sdt == false" class="text-danger" style="font-size: 13px">
          <i class="fa-solid fa-triangle-exclamation"></i> Số điện thoại phải là 10 số!
        </span>
        <div class="mb-3">
        ...
        <span v-if="error.pass == false" class="text-danger" style="font-size: 13px">
          <i class="fa-solid fa-triangle-exclamation"></i> Mật khẩu phải có tối thiểu 6 ký tự!
        </span>
        <div class="d-flex justify-content-center">
...
<script>
import add from "../services/khachhang.service";
export default {
  data() {
    return {
      khachhang: {
      ...
      if (
        ...
        try {
          await add
            .add(this.khachhang)
            .then(
              alert("Thêm khách hàng thanh cong"),
